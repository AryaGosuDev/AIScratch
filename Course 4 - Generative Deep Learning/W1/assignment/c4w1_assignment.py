...
Original file is located at
    https://colab.research.google.com/github/https-deeplearning-ai/tensorflow-3-public/blob/main/Course%204%20-%20Generative%20Deep%20Learning/W1/assignment/C4W1_Assignment.ipynb
...
gif_images_reg = [np.squeeze(image.numpy().astype(np.uint8), axis=0) for image in display_images]
gif_path_reg = create_gif(GIF_PATH, gif_images_reg)

tf.keras.preprocessing.image.save_img(
    "stylized_dog.png",
    tf.squeeze(stylized_image, axis=0)
)
